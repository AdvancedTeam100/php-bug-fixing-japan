...
<main>
  <h1>アンケート集計</h1>
  <div class="row questionnaire_tally">
    <div class="col-md-6">
      <h2>Q1 :
        <?= $question_items_data[0]['question'] ?>
      </h2>
      <p>選択肢 :
        <?= $question_items_data[0]['choices'] ?>
      </p>
    ...
    <div class="col-md-6">
      <h2>Q2 :
        <?= $question_items_data[1]['question'] ?>
      </h2>
      <p>選択肢 :
        <?= $question_items_data[1]['choices'] ?>
      </p>
    ...
    <div class="col-md-6">
      <h2>Q3 :
        <?= $question_items_data[2]['question'] ?>
      </h2>
      <p>選択肢 :
        <?= $question_items_data[2]['choices'] ?>
      </p>
    ...
    <div class="col-md-6">
      <h2>Q4 :
        <?= $question_items_data[3]['question'] ?>
      </h2>
      <p>選択肢 :
        <?= $question_items_data[3]['choices'] ?>
      </p>
    ...
    <div class="col-md-6">
      <h2>Q5 :
        <?= $question_items_data[4]['question'] ?>
      </h2>
      <p>選択肢 :
        <?= $question_items_data[4]['choices'] ?>
      </p>
