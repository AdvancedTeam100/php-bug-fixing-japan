...
<main>
  ...
  <div class="content">
    ...
    <br><br>
    <!-- 新規投稿モーダル -->
    <div class="modal fade" id="newColumnModal" tabindex="-1" role="dialog" aria-labelledby="newColumnModalLabel"
      aria-hidden="true">
    ...
    <div class="responsive-table">
      <table class="t">
        ...
        <?php foreach (array_reverse($columns_data, true) as $column_data): ?>
          <tr>
            <td><img src="<?= $column_data['image_path'] ?>" class="img-thumbnail" style="height: 150px; width: 150px; max-width: none">
            </td>
            <td>
              <?= $column_data['title'] ?>
            </td>
            ...
            <td>
              ...
              <button type="button" class="btn btn-primary" data-toggle="modal"
                data-target="#myModal<?= $column_data['id'] ?>">詳細</button>
              <!-- モーダル -->
