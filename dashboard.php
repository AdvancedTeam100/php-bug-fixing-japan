...
try {
    ...
    $stmt = $db->prepare("SELECT user_id, COUNT(*) as visit_count, DATE(visit_date) as visit_date FROM visits GROUP BY DATE(visit_date) ORDER BY visit_date");
    $stmt->execute();
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div style="width:400px"><canvas id="chart1"></canvas></div>
                    <?php
                    $i = 0;
                    ...
                    <script>
                        // Q1
                        var time_Array = [<?php for ($j = 0; $j < $i; $j++) {
                            echo "'".$visit_date[$j] . "',";
                        } ?>];
